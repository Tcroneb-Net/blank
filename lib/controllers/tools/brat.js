 ...
 * @description Membuat meme teks gaya "Brat" berdasarkan input teks. Menggunakan browser automation untuk melakukan rendering dan screenshot.
 * @method POST
 * @path /api/tools/brat
 * @response json
 ...
 *     body: JSON.stringify({ "text": "I'm a brat" })
 *   });
